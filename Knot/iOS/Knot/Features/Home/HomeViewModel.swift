...
//  Step 4.1: Home screen data management — vault loading, milestone countdowns.
//  Step 6.6: Added saved recommendations loading from SwiftData for the Home screen Saved section.
//  Step 18.6: Removed hint submission/loading (capture moved into recommendation refresh flow).
//
