...
- **External APIs:** `YELP_API_KEY` (Step 8.1), `TICKETMASTER_API_KEY` (Step 8.2), `AMAZON_ACCESS_KEY`/`AMAZON_SECRET_KEY`/`AMAZON_ASSOCIATE_TAG` (Step 8.3), `SHOPIFY_STOREFRONT_TOKEN`/`SHOPIFY_STORE_DOMAIN` (Step 8.4), Firecrawl keys (future steps)
