...
[Privacy Policy](privacy-policy.md), which is incorporated by reference. If you do not
agree, do not use the Service.

## 2. Eligibility

You must be at least **18 years old** and able to form a binding contract to use the
Service. By using Knot, you represent and warrant that you meet these requirements.

## 3. The Service

Knot helps you plan gifts, dates, experiences, and gestures for your romantic partner
by collecting details about that person and generating personalized suggestions using
artificial intelligence and third-party data sources.

Recommendations are **suggestions only**. We do not guarantee that any recommended
product, event, restaurant, price, or availability is accurate, current, in stock, or
suitable for you. You are responsible for verifying details before you rely on or
purchase anything.

## 4. Accounts and sign-in

You create an account using Sign in with Apple, Google Sign-In, or an email magic
link. You are responsible for maintaining the security of your account and the device
and credentials used to access it, and for all activity that occurs under your
account. You agree to provide accurate information and to keep it up to date. Notify us
promptly of any unauthorized use.

## 5. Your content and information about your partner

You retain ownership of the content and information you provide to the Service (your
partner's profile, hints, milestones, and similar — "Your Content"). You grant us a
limited, non-exclusive, worldwide, royalty-free license to host, store, process, and
use Your Content **solely to operate, provide, secure, and improve the Service for
you**, including by sending relevant portions to the third-party providers described
in our Privacy Policy.

You represent and warrant that:
- You have the right to provide Your Content, including any information about your
  partner or other people;
- You have a lawful and appropriate basis to enter information about your partner and
  to use the Service to plan for them; and
- Your Content does not violate any law or the rights of any third party.

## 6. Acceptable use

You agree not to:
- Use the Service for any unlawful, harmful, harassing, or abusive purpose, or to
  stalk, monitor, or harm any person;
- Enter another person's information without a lawful basis to do so;
- Attempt to reverse engineer, decompile, disrupt, overload, or gain unauthorized
  access to the Service or its systems;
- Scrape, harvest, or bulk-extract data from the Service, or use it to build a
  competing product;
- Misuse third-party content or violate the terms of any linked merchant or service.

## 7. AI-generated content

The Service uses artificial intelligence to generate recommendations and ideas.
AI-generated content may be **inaccurate, incomplete, outdated, or unavailable**, and
prices and availability change frequently. AI suggestions are for informational and
inspirational purposes only and are **not** professional, financial, relationship, or
other advice. Always confirm details with the relevant merchant or source before
acting.

## 8. Third-party merchants, links, and affiliate relationships

The Service links to third-party merchants, booking platforms, and websites. We do
not control and are not responsible for third-party products, services, content, or
practices. Any purchase, reservation, or transaction is solely between you and the
third party, under their terms and privacy policy.

Some links are **affiliate links**, which means we may earn a commission if you make a
purchase or booking through them, at no additional cost to you. This does not change
the price you pay.

## 9. Intellectual property

The Service, including the Knot name, logo, software, design, and content we provide
(excluding Your Content), is owned by us or our licensors and is protected by
...
If you enable notifications, you consent to receive push notifications and reminders
related to your milestones and the Service. You can turn notifications off and adjust
quiet hours at any time in the app. We may also send you service-related
...
RECOMMENDATIONS WILL BE ACCURATE OR SUITABLE. TO THE EXTENT A JURISDICTION DOES NOT
ALLOW THE EXCLUSION OF CERTAIN WARRANTIES, THE ABOVE EXCLUSIONS MAY NOT APPLY TO YOU.
...
GREATER OF (A) THE AMOUNT YOU PAID US, IF ANY, IN THE 12 MONTHS BEFORE THE CLAIM, OR
(B) USD $50. SOME JURISDICTIONS DO NOT ALLOW CERTAIN LIMITATIONS, SO SOME OF THE ABOVE
...
**the State of California, USA** will have exclusive jurisdiction over any dispute
arising out of or relating to these Terms or the Service, and you consent to their
...
within the app. Your continued use of the Service after an update means you accept the
revised Terms.
